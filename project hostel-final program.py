...
class hostelapp(tk.Tk):         
    def __init__(self, *args, **kwargs):
        ...
        tk.Tk.wm_title(self,"MEC Hostel")
...
class FirstPage(tk.Frame):
    def __init__(self,parent,controller):
        ...
        c1 = tk.Canvas(self)       
        c1.pack(fill="both", expand=True)
        c1.configure(bg="whitesmoke")
        c1.create_image(35,15,image = img.image,anchor ="nw")
        c1.create_text(750,80,text="MEC HOSTEL ",font=VV_LARGE_F)
        c1.create_line(0,180,1800,180,fill="orange")
        but1=tk.Button(self,text="New Student",width=25,height=2,font=Sm_F,fg="black",bg="orange",relief="raised",command=lambda:new_stud())
        but1.place(x=14,y=187)
        but2=tk.Button(self,text="Existing Student",width=25,height=2,font=Sm_F,fg="black",bg="orange",relief="raised",command=lambda:exist_stud()) 
        but3=tk.Button(self,text="Visitors",width=25,height=2,font=Sm_F,fg="black",bg="orange",relief="raised",command=lambda:visitors())
        but4=tk.Button(self,text="Outings",width=25,height=2,font=Sm_F,fg="black",bg="orange",relief="raised",command=lambda:outings())
        but5=tk.Button(self,text="Fees Renewal",width=25,height=2,font=Sm_F,fg="black",bg="orange",relief="raised",command=lambda:Fees())
        but6=tk.Button(self,text="Mess Employee",width=25,height=2,font=Sm_F,fg="black",bg="orange",relief="raised",command=lambda:mess_employee())
        but7=tk.Button(self,text="Warden",width=25,height=2,font=Sm_F,fg="black",bg="orange",relief="raised",command=lambda:warden_employee())
        but8=tk.Button(self,text="Logout",width=25,height=2,font=Sm_F,fg="black",bg="orange",relief="raised",command=lambda:controller.show_frame(LoginPage))
